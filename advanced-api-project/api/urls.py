...
urlpatterns = [
    ...
    path('books/<int:pk>/update/', views.UpdateView.as_view(), name='book-update'),  # UpdateView for modifying an existing book
    path('books/<int:pk>/delete/', views.DeleteView.as_view(), name='book-delete'),  # DeleteView for removing a book
